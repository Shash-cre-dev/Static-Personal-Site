...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{Shashank}{Kumar}{ \urlstyle{same}\href{https://shash-cre-dev.github.io/shashankkumar/}{shashankkumar.io}|+91 9188813209 |
\href{mailto:callshash@gmail.com}{callshash@gmail} | \href{mailto:shashwritescode@gmail.com}{shashwritescode@gmail}
}
...
\location{August 2021 to Present | Chennai, TN}
Chennai Campus \\
\location{  CGPA: 9.4 \\
GPA: 9.69 }
\sectionsep
...
\descript{Class 12th}
\location{Grad. May 2020 | Kochi, Kerala} 
\location{Percentage: 93.8} 
\sectionsep

\subsection{KV NO 1 Naval Base}
\descript{Class 10th} 
\location{Grad. May 2018 | Kochi, Kerala} 
\location{Percentage: 94.2}
\sectionsep
...
\textbullet{} HTML \textbullet{}   CSS \textbullet{} JavaScript \textbullet{}  C++\\
\location{Over 1000 lines:}
\textbullet{}C \textbullet{} Python \textbullet{} React \textbullet{} MySQL \textbullet{} Java \
\location{Familiar:}
\textbullet{} R \textbullet{} Linux \textbullet{} Latex
\sectionsep

\subsection{Blogging}
\location{Technical - Hashnode}
\textbullet{} Simplifying Data  \textbullet{}  CSS Flexbox 1-3\\
\location{Non-Technical - Medium }
\textbullet{} Focus \textbullet{} 4R Principle \textbullet{} Mind Traps 1-4\\
\sectionsep
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%     COLUMN TWO
